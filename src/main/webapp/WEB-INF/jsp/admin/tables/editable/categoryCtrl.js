/**
 * Created by quangphuong on 9/18/16.
 */
'use strict';

angular.module('newApp')
    .controller('categoryCtrl', ['$scope', '$http', function ($scope, $http) {
        var columns = ["categoryId", "name"];
        $scope.$on('$viewContentLoaded', function () {
            ...
            function editableTable() {
                ...
                $('#category-edit_new').click(function (e) {
                    e.preventDefault();
                ...
                $('#table-category a.add').live('click', function (e) {
                ...
                $('#table-category a.delete').live('click', function (e) {
                    e.preventDefault();
                ...
                $('#table-category a.cancel').live('click', function (e) {
                    e.preventDefault();
                ...
                $('#table-category a.edit').live('click', function (e) {
                    e.preventDefault();
